 ...
 *
 * @see <a href="https://www.hl7.org/fhir">ExplanationOfBenefit_Item</a>
 */
public
class ExplanationOfBenefitItem extends BackboneElement implements Serializable
{
  ...
  protected ExplanationOfBenefitDetail[] detail;
  ...
  public ExplanationOfBenefitDetail[] getDetail() {
    return detail;
  }
  
  public void setDetail(ExplanationOfBenefitDetail[] detail) {
    this.detail = detail;
  }
  ...
  public boolean equals(Object object) {
    if(object instanceof ExplanationOfBenefitItem) {
  ...
  public String toString() {
    return "ExplanationOfBenefitItem(" + id + ")";
  }
}
