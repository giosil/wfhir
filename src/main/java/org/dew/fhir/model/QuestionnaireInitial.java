 ...
 *
 * @see <a href="https://www.hl7.org/fhir">Questionnaire_Initial</a>
 */
public
class QuestionnaireInitial extends BackboneElement implements Serializable
{
  ...
  public boolean equals(Object object) {
    if(object instanceof QuestionnaireInitial) {
  ...
  public String toString() {
    return "QuestionnaireInitial(" + id + ")";
  }
}
