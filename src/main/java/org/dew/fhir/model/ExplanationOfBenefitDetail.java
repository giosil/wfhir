 ...
 *
 * @see <a href="https://www.hl7.org/fhir">ExplanationOfBenefit_Detail</a>
 */
public
class ExplanationOfBenefitDetail extends BackboneElement implements Serializable
{
  ...
  protected ExplanationOfBenefitSubDetail[] subDetail;
  ...
  public ExplanationOfBenefitSubDetail[] getSubDetail() {
    return subDetail;
  }
  
  public void setSubDetail(ExplanationOfBenefitSubDetail[] subDetail) {
  ...
  public boolean equals(Object object) {
    if(object instanceof ExplanationOfBenefitDetail) {
  ...
  public String toString() {
    return "ExplanationOfBenefitDetail(" + id + ")";
  }
}
