 ...
 *
 * @see <a href="https://www.hl7.org/fhir">ExplanationOfBenefit_Detail1</a>
 */
public
class ExplanationOfBenefitDetail1 extends BackboneElement implements Serializable
{
  ...
  protected ExplanationOfBenefitSubDetail1[] subDetail;
  ...
  public ExplanationOfBenefitSubDetail1[] getSubDetail() {
    return subDetail;
  }
  
  public void setSubDetail(ExplanationOfBenefitSubDetail1[] subDetail) {
  ...
  public boolean equals(Object object) {
    if(object instanceof ExplanationOfBenefitDetail1) {
  ...
  public String toString() {
    return "ExplanationOfBenefitDetail1(" + id + ")";
  }
}
